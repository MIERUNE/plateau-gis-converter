...
<div class="grid place-items-center h-screen">
	<div class="max-w-md flex flex-col gap-7">
		...
		<p>
			...
			<br />・GeoPackage 形式による QGIS 等での解析
			<br />・Mapbox Vector Tiles (MVT) 形式による、大規模データのWeb等での高速描画
			<br />・KML 形式による Google Earth での可視化
			<br />・3D Tiles 形式による Cesium 等での可視化
			<br />・など
		</p>
		...
		<p>
			ソフトウェアの最新版は
			<a href="https://github.com/MIERUNE/PLATEAU-GIS-Converter/releases" target="_blank"
				>Releaseページ</a
			>
			からダウンロードしてください。
			<br />
			詳しい利用方法については、こちらの
			<a href="https://mierune.github.io/PLATEAU-GIS-Converter/index.html" target="_blank"
				>マニュアル</a
			>をご覧ください。
		</p>
