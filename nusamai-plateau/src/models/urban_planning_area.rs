...
#[citygml_property(name = "urf:DistrictsAndZonesProperty")]
pub enum DistrictsAndZonesProperty {
    #[citygml(path = b"urf:DistrictsAndZones")]
    DistrictsAndZones(DistrictsAndZones),
    #[citygml(path = b"urf:AircraftNoiseControlZone")]
    AircraftNoiseControlZone(AircraftNoiseControlZone),
    #[citygml(path = b"urf:ConservationZoneForClustersOfTraditionalStructures")]
    ConservationZoneForClustersOfTraditionalStructures(ConservationZoneForClustersOfTraditionalStructures),
    #[citygml(path = b"urf:DistributionBusinessZone")]
    DistributionBusinessZone(DistributionBusinessZone),
    #[citygml(path = b"urf:ExceptionalFloorAreaRateDistrict")]
    ExceptionalFloorAreaRateDistrict(ExceptionalFloorAreaRateDistrict),
    ...
    GreenSpaceConservationDistrict(GreenSpaceConservationDistrict),
    #[citygml(path = b"urf:HeightControlDistrict")]
    HeightControlDistrict(HeightControlDistrict),
    #[citygml(path = b"urf:HighLevelUseDistrict")]
    HighLevelUseDistrict(HighLevelUseDistrict),
    #[citygml(path = b"urf:HighRiseResidentialAttractionDistrict")]
    HighRiseResidentialAttractionDistrict(HighRiseResidentialAttractionDistrict),
    #[citygml(path = b"urf:HousingControlArea")]
    HousingControlArea(HousingControlArea),
    #[citygml(path = b"urf:LandscapeZone")]
    LandscapeZone(LandscapeZone),
    #[citygml(path = b"urf:ParkingPlaceDevelopmentZone")]
    ParkingPlaceDevelopmentZone(ParkingPlaceDevelopmentZone),
    #[citygml(path = b"urf:PortZone")]
    PortZone(PortZone),
    #[citygml(path = b"urf:ProductiveGreenZone")]
    ProductiveGreenZone(ProductiveGreenZone),
    #[citygml(path = b"urf:ResidentialEnvironmentImprovementDistrict")]
    ResidentialEnvironmentImprovementDistrict(ResidentialEnvironmentImprovementDistrict),
    #[citygml(path = b"urf:ScenicDistrict")]
    ScenicDistrict(ScenicDistrict),
    #[citygml(path = b"urf:SpecialGreenSpaceConservationDistrict")]
    SpecialGreenSpaceConservationDistrict(SpecialGreenSpaceConservationDistrict),
    #[citygml(path = b"urf:SpecialUrbanRenaissanceDistrict")]
    SpecialUrbanRenaissanceDistrict(SpecialUrbanRenaissanceDistrict),
    #[citygml(path = b"urf:SpecialUseAttractionDistrict")]
    SpecialUseAttractionDistrict(SpecialUseAttractionDistrict),
    #[citygml(path = b"urf:SpecialUseDistrict")]
    SpecialUseDistrict(SpecialUseDistrict),
    #[citygml(path = b"urf:SpecialUseRestrictionDistrict")]
    SpecialUseRestrictionDistrict(SpecialUseRestrictionDistrict),
    #[citygml(path = b"urf:SpecialZoneForPreservationOfHistoricalLandscape")]
    SpecialZoneForPreservationOfHistoricalLandscape(SpecialZoneForPreservationOfHistoricalLandscape),
    #[citygml(path = b"urf:SpecifiedBlock")]
    SpecifiedBlock(SpecifiedBlock),
    #[citygml(path = b"urf:SpecifiedDisasterPreventionBlockImprovementZone")]
    SpecifiedDisasterPreventionBlockImprovementZone(SpecifiedDisasterPreventionBlockImprovementZone),
    #[citygml(path = b"urf:TreePlantingDistrict")]
    TreePlantingDistrict(TreePlantingDistrict),
    #[citygml(path = b"urf:UseDistrict")]
    UseDistrict(UseDistrict),
    #[citygml(path = b"urf:ZoneForPreservationOfHistoricalLandscape")]
    ZoneForPreservationOfHistoricalLandscape(ZoneForPreservationOfHistoricalLandscape),
}
...
#[citygml_property(name = "urf:ProjectPromotionAreaProperty")]
pub enum ProjectPromotionAreaProperty {
    #[citygml(path = b"urf:ProjectPromotionArea")]
    ProjectPromotionArea(ProjectPromotionArea),
    #[citygml(path = b"urf:LandReadjustmentPromotionArea")]
    LandReadjustmentPromotionArea(LandReadjustmentPromotionArea),
    #[citygml(path = b"urf:LandReadjustmentPromotionAreasForCoreBusinessUrbanDevelopment")]
    LandReadjustmentPromotionAreasForCoreBusinessUrbanDevelopment(LandReadjustmentPromotionAreasForCoreBusinessUrbanDevelopment),
    #[citygml(path = b"urf:ResidentialBlockConstructionPromotionArea")]
    ResidentialBlockConstructionPromotionArea(ResidentialBlockConstructionPromotionArea),
    #[citygml(path = b"urf:UrbanRedevelopmentPromotionArea")]
    UrbanRedevelopmentPromotionArea(UrbanRedevelopmentPromotionArea),
}
...
#[citygml_property(name = "urf:UrbanFacilityProperty")]
pub enum UrbanFacilityProperty {
    #[citygml(path = b"urf:UrbanFacility")]
    UrbanFacility(UrbanFacility),
    #[citygml(path = b"urf:CollectiveFacilitiesForReconstruction")]
    CollectiveFacilitiesForReconstruction(CollectiveFacilitiesForReconstruction),
    #[citygml(path = b"urf:CollectiveFacilitiesForReconstructionAndRevitalization")]
    CollectiveFacilitiesForReconstructionAndRevitalization(CollectiveFacilitiesForReconstructionAndRevitalization),
    #[citygml(path = b"urf:CollectiveFacilitiesForTsunamiDisasterPrevention")]
    CollectiveFacilitiesForTsunamiDisasterPrevention(CollectiveFacilitiesForTsunamiDisasterPrevention),
    #[citygml(path = b"urf:CollectiveGovernmentAndPublicOfficeFacilities")]
    CollectiveGovernmentAndPublicOfficeFacilities(CollectiveGovernmentAndPublicOfficeFacilities),
    #[citygml(path = b"urf:CollectiveHousingFacilities")]
    CollectiveHousingFacilities(CollectiveHousingFacilities),
    #[citygml(path = b"urf:CollectiveUrbanDisasterPreventionFacilities")]
    CollectiveUrbanDisasterPreventionFacilities(CollectiveUrbanDisasterPreventionFacilities),
    #[citygml(path = b"urf:DistributionBusinessPark")]
    DistributionBusinessPark(DistributionBusinessPark),
    #[citygml(path = b"urf:EducationalAndCulturalFacility")]
    EducationalAndCulturalFacility(EducationalAndCulturalFacility),
    #[citygml(path = b"urf:FireProtectionFacility")]
    FireProtectionFacility(FireProtectionFacility),
    #[citygml(path = b"urf:FloodPreventionFacility")]
    FloodPreventionFacility(FloodPreventionFacility),
    #[citygml(path = b"urf:MarketsSlaughterhousesCrematoria")]
    MarketsSlaughterhousesCrematoria(MarketsSlaughterhousesCrematoria),
    #[citygml(path = b"urf:MedicalFacility")]
    MedicalFacility(MedicalFacility),
    #[citygml(path = b"urf:OpenSpaceForPublicUse")]
    OpenSpaceForPublicUse(OpenSpaceForPublicUse),
    #[citygml(path = b"urf:SandControlFacility")]
    SandControlFacility(SandControlFacility),
    #[citygml(path = b"urf:SnowProtectionFacility")]
    SnowProtectionFacility(SnowProtectionFacility),
    #[citygml(path = b"urf:SocialWelfareFacility")]
    SocialWelfareFacility(SocialWelfareFacility),
    #[citygml(path = b"urf:SupplyFacility")]
    SupplyFacility(SupplyFacility),
    #[citygml(path = b"urf:TelecommunicationFacility")]
    TelecommunicationFacility(TelecommunicationFacility),
    #[citygml(path = b"urf:TideFacility")]
    TideFacility(TideFacility),
    #[citygml(path = b"urf:TrafficFacility")]
    TrafficFacility(TrafficFacility),
    ...
    UrbanFacilityStipulatedByCabinetOrder(UrbanFacilityStipulatedByCabinetOrder),
    #[citygml(path = b"urf:Waterway")]
    Waterway(Waterway),
    #[citygml(path = b"urf:WindProtectionFacility")]
    WindProtectionFacility(WindProtectionFacility),
}
...
pub struct TrafficFacility {
    ...
    #[citygml(path = b"urf:urbanRapidTransitRailroadAttribute/urf:UrbanRapidTransitRailroadAttribute")]
...
#[citygml_property(name = "urf:UrbanDevelopmentProjectProperty")]
pub enum UrbanDevelopmentProjectProperty {
    #[citygml(path = b"urf:UrbanDevelopmentProject")]
    UrbanDevelopmentProject(UrbanDevelopmentProject),
    #[citygml(path = b"urf:DisasterPreventionBlockImprovementProject")]
    DisasterPreventionBlockImprovementProject(DisasterPreventionBlockImprovementProject),
    #[citygml(path = b"urf:IndustrialParkDevelopmentProject")]
    IndustrialParkDevelopmentProject(IndustrialParkDevelopmentProject),
    #[citygml(path = b"urf:LandReadjustmentProject")]
    LandReadjustmentProject(LandReadjustmentProject),
    #[citygml(path = b"urf:NewHousingAndUrbanDevelopmentProject")]
    NewHousingAndUrbanDevelopmentProject(NewHousingAndUrbanDevelopmentProject),
    #[citygml(path = b"urf:NewUrbanInfrastructureProject")]
    NewUrbanInfrastructureProject(NewUrbanInfrastructureProject),
    #[citygml(path = b"urf:ResidentialBlockConstructionProject")]
    ResidentialBlockConstructionProject(ResidentialBlockConstructionProject),
    #[citygml(path = b"urf:UrbanRedevelopmentProject")]
    UrbanRedevelopmentProject(UrbanRedevelopmentProject),
    #[citygml(path = b"urf:UrbanRenewalProject")]
    UrbanRenewalProject(UrbanRenewalProject),
}
...
#[citygml_property(name = "urf:ScheduledAreaForUrbanDevelopmentProjectProperty")]
pub enum ScheduledAreaForUrbanDevelopmentProjectProperty {
    #[citygml(path = b"urf:ScheduledAreaForUrbanDevelopmentProject")]
    ScheduledAreaForUrbanDevelopmentProject(ScheduledAreaForUrbanDevelopmentProject),
    #[citygml(path = b"urf:ScheduledAreaForCollectiveGovernmentAndPublicOfficeFacilities")]
    ScheduledAreaForCollectiveGovernmentAndPublicOfficeFacilities(ScheduledAreaForCollectiveGovernmentAndPublicOfficeFacilities),
    #[citygml(path = b"urf:ScheduledAreaForCollectiveHousingFacilities")]
    ScheduledAreaForCollectiveHousingFacilities(ScheduledAreaForCollectiveHousingFacilities),
    #[citygml(path = b"urf:ScheduledAreaForDistributionBusinessPark")]
    ScheduledAreaForDistributionBusinessPark(ScheduledAreaForDistributionBusinessPark),
    #[citygml(path = b"urf:ScheduledAreaForIndustrialParkDevelopmentProjects")]
    ScheduledAreaForIndustrialParkDevelopmentProjects(ScheduledAreaForIndustrialParkDevelopmentProjects),
    #[citygml(path = b"urf:ScheduledAreaForNewHousingAndUrbanDevelopmentProjects")]
    ScheduledAreaForNewHousingAndUrbanDevelopmentProjects(ScheduledAreaForNewHousingAndUrbanDevelopmentProjects),
    #[citygml(path = b"urf:ScheduledAreaForNewUrbanInfrastructureProjects")]
    ScheduledAreaForNewUrbanInfrastructureProjects(ScheduledAreaForNewUrbanInfrastructureProjects),
}
...
pub enum DistrictDevelopmentPlanProperty {
    ...
    DistrictImprovementPlanForDisasterPreventionBlockImprovementZonePlan(DistrictImprovementPlanForDisasterPreventionBlockImprovementZonePlan),
    #[citygml(path = b"urf:DistrictImprovementPlanForHistoricSceneryMaintenanceAndImprovementDistrict")]
    DistrictImprovementPlanForHistoricSceneryMaintenanceAndImprovementDistrict(DistrictImprovementPlanForHistoricSceneryMaintenanceAndImprovementDistrict),
...
#[citygml_feature(name = "urf:DistrictImprovementPlanForDisasterPreventionBlockImprovementZonePlan")]
...
#[citygml_feature(name = "urf:DistrictImprovementPlanForHistoricSceneryMaintenanceAndImprovementDistrict")]
