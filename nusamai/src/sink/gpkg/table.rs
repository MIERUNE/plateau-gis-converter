...
mod tests {
    ...
    fn test_schema_to_table_infos() {
        let mut types = IndexMap::with_hasher(foldhash::fast::RandomState::default());

        let mut attrs_1 = IndexMap::with_hasher(foldhash::fast::RandomState::default());
        ...
        let mut attrs_2 = IndexMap::with_hasher(foldhash::fast::RandomState::default());
        attrs_2.insert(
            "json".into(),
